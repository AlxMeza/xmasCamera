...
export default function SecondFrame () {
  ...
  const capture = React.useCallback(() => {
    ...
    photo.innerHTML = `
      <img src="assets/frame2.svg" style="z-index: 2; width: 720px; position:absolute;" />
  ...
  const savePicture = () => {
    const contenido = document.getElementById('photo')
  ...
  return(
    <>
      <div>
        <section className='bg-red-300 my-5 px-20 py-10 w-10/12 rounded-lg mx-auto'>
          <div className='grid justify-items-center'>
            <section>
              <div className='h-[720px] w-[720px] absolute flex items-end'><img src='assets/frame2.svg' alt='frame1'/></div>
